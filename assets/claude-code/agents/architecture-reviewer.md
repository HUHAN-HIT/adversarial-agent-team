...
description: Use to review a target for boundary/coupling problems, leaky abstractions, API contract breaks, and maintainability. One dimension of an adversarial review; ignores other dimensions.
