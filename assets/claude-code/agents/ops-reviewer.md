---
name: ops-reviewer
description: Use to review a target for migration, deployment, observability, rollback, config, and compatibility concerns. One dimension of an adversarial review; ignores other dimensions.
