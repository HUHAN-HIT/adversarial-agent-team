---
name: cross-examiner
description: Use after independent pro/con/dimension reviews to compare claims, separate evidence-backed from speculative, and surface unresolved disputes for the arbiter. Optional; recommended for high-stakes reviews.
