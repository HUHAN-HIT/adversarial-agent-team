---
name: scribe
description: Use to write the final adversarial review report from the arbiter decision and all role findings — preserving real disagreement and listing findings by severity.
tools: Read, Write
---
