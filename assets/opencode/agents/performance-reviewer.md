---
description: Review a target for complexity, memory, latency, unnecessary work, and scaling limits. One dimension of an adversarial review; ignores other dimensions.
mode: subagent
temperature: 0.1
tools:
  write: false
