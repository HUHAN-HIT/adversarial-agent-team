---
description: Challenge a target — code, plan, or decision — by finding risks, hidden assumptions, edge cases, missing tests, and reasons to revise or reject. Evidence-backed only.
mode: subagent
temperature: 0.2
tools:
  write: false
