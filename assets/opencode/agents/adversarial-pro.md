---
description: Defend a target — code change, plan, or decision — by making the strongest evidence-backed case for accepting it, and stating the conditions required for acceptance.
mode: subagent
temperature: 0.2
tools:
  write: false
