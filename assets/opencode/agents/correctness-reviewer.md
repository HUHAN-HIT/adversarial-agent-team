---
description: Review a target for logic bugs, race conditions, state errors, and boundary cases. One dimension of an adversarial review; ignores other dimensions.
mode: subagent
temperature: 0.1
tools:
  write: false
